export type Texts = {
  ...
  startRecitation: string;
  recitationBoth: string;
  recitationBlack: string;
  recitationWhite: string;
  recitationSideChangeConfirm: string;
  previousMove: string;
  plyNofM(n: number, m: number): string;
  mistakeCount: string;
  pleaseTryAgain: string;
  hint: string;
  restartRecitation: string;
  areYouSureWantToQuitRecitation: string;
  doYouWantToRestartRecitation: string;
  recitationCompleted: string;
  recitationResult(totalPly: number, mistakeCount: number, elapsed: string): string;
