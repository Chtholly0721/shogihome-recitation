...
export const ja: Texts = {
  ...
  sourceRecord: "出典棋譜",
  recitationMode: "背譜",
  startRecitation: "背譜を開始",
  recitationBoth: "先手と後手",
  recitationBlack: "先手のみ",
  recitationWhite: "後手のみ",
  recitationSideChangeConfirm: "背譜する手番を変更しますか？変更すると最初からやり直します。",
  previousMove: "前の一手",
  plyNofM: (n: number, m: number) => `第${n}手 / 全${m}手`,
  mistakeCount: "誤り",
  pleaseTryAgain: "もう一度お試しください。",
  hint: "ヒント",
  restartRecitation: "最初からやり直す",
  areYouSureWantToQuitRecitation: "背譜を終了しますか？",
  doYouWantToRestartRecitation: "背譜を最初からやり直しますか？",
  recitationCompleted: "背譜が完了しました。",
  recitationResult: (totalPly: number, mistakeCount: number, elapsed: string) =>
    `総手数: ${totalPly} / 誤り: ${mistakeCount}回 / 経過時間: ${elapsed}`,
