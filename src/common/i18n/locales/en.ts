...
export const en: Texts = {
  ...
  recitationMode: "Recitation",
  startRecitation: "Start Recitation",
  recitationBoth: "Both Sides",
  recitationBlack: "Sente Only",
  recitationWhite: "Gote Only",
  recitationSideChangeConfirm:
    "Change the side to recite? The recitation will restart from the beginning.",
  previousMove: "Previous Move",
  plyNofM: (n: number, m: number) => `Move ${n} / ${m}`,
  mistakeCount: "Mistakes",
  pleaseTryAgain: "Please try again.",
  hint: "Hint",
  restartRecitation: "Restart",
  areYouSureWantToQuitRecitation: "Do you want to quit the recitation?",
  doYouWantToRestartRecitation: "Do you want to restart the recitation?",
  recitationCompleted: "Recitation completed!",
  recitationResult: (totalPly: number, mistakeCount: number, elapsed: string) =>
    `Total moves: ${totalPly} / Mistakes: ${mistakeCount} / Elapsed: ${elapsed}`,
