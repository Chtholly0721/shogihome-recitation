<template>
  <div
    ...
    :class="[
      ...
      dialogPosition,
      dialogBackdrop,
      { 'recitation-active': store.appState === AppState.RECITATION },
    ]"
    :style="style"
  >
    <!-- Main Contents -->
    ...
    <MobileRecitationDialog v-if="store.appState === AppState.RECITATION && isMobileWebApp()" />
    <RecitationDialog v-else-if="store.appState === AppState.RECITATION" />
    <CSAGameReadyDialog
      v-if="
...
import RecitationDialog from "./dialog/RecitationDialog.vue";
import MobileRecitationDialog from "./dialog/MobileRecitationDialog.vue";
